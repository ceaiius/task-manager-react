  ...
  return (
     <div className="bg-white p-6 rounded-xl shadow-lg mb-8">
        <form onSubmit={handleSubmit} className="flex items-center space-x-3">
            ...
            className={`flex-grow px-4 py-2 border rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm disabled:bg-gray-50 ${validationError ? 'border-red-500' : 'border-gray-300'}`}
            disabled={isLoading}
            />
            <button
            type="submit"
